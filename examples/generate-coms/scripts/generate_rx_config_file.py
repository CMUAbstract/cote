# Usage: python3 generate_rx_config_file.py /path/to/src/ ext max_gain_db center_frequency_hz bandwidth_hz /path/to/dst/
# Input:
...
if len(sys.argv)==7:
  ...
  print("Usage: python3 generate_rx_config_file.py /path/to/src/ max_gain_db center_frequency_hz bandwidth_hz /path/to/dst/")
  exit()
