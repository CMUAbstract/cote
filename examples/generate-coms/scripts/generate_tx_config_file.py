# Usage: python3 generate_tx_config_file.py /path/to/src/ ext power_w line_loss_db max_gain_db center_frequency_hz bandwidth_hz /path/to/dst/
# Input:
...
if len(sys.argv)==9:
  ...
  print("Usage: python3 generate_tx_config_file.py /path/to/src/ power_w line_loss_db max_gain_db center_frequency_hz bandwidth_hz /path/to/dst/")
  exit()
