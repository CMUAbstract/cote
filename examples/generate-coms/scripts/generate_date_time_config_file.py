# Usage: python3 generate_date_time_config_file.py /path/to/src/ /path/to/dst/
# Parameters:
#  /path/to/src/: directory containing satellite TLE file(s)
...
if len(sys.argv)==3:
  ...
  print("Usage: python3 generate_date_time_config_file.py /path/to/src/ /path/to/dst/")
  exit()
