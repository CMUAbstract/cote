#!/bin/bash
# Usage: ./run_close_spaced_scenarios.sh
#
# run_close_spaced_scenarios.sh
...
./prep_close_spaced_scenarios.sh
cd ../build/
...
do
  ...
  do
    ...
    gnd_config=ns
    ./close_spaced ../configuration/$sat_config-$sat_count-$gnd_config-$gnd_count/ \
