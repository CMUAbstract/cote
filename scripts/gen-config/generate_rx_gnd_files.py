# Usage: python3 generate_rx_gnd_files.py /path/to/src/ /path/to/seed.dat /path/to/dst/
# Parameters:
#  /path/to/src/: directory containing *.gnd files
#  /path/to/seed.dat: rx-gnd.dat seed file with ignored leading ID field
