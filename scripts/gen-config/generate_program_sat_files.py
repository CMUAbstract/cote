# Usage: python3 generate_program_sat_files.py count /path/to/seed.tle /path/to/seed.dat /path/to/dst/
# Parameters:
...
if len(sys.argv)==5:
  ...
  print(\
   'Usage: '\
   'python3 generate_program_sat_files.py '\
...
for i in range(0,cnt):
  ...
  # generate file name
  filename = 'program-sat-'+id_str+'.dat'
