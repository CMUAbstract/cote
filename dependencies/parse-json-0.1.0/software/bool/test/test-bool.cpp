...
int main(int argc, char** argv) {
  ...
  json::Bool*  input02 = nullptr;
  json::Bool*  input03 = nullptr;
  json::Value* input04 = nullptr;
  json::Value* input05 = nullptr;
  json::Bool*  input06 = nullptr;
  json::Bool*  input07 = nullptr;
  json::Value* input08 = nullptr;
  json::Value* input09 = nullptr;
  json::Bool*  input10 = nullptr;
  json::Bool*  input11 = nullptr;
  ...
  std::cout << "Test: getValue..."
            << std::endl;
  pass = dynamic_cast<json::Bool*>(input00)->getValue()==true;
  std::cout << "  input00 true: " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = dynamic_cast<json::Bool*>(input01)->getValue()==true;
  std::cout << "  input01 true: " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = input02->getValue()==true;
  std::cout << "  input02 true: " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = input03->getValue()==true;
  std::cout << "  input03 true: " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = dynamic_cast<json::Bool*>(input04)->getValue()==false;
  std::cout << "  input04 false: " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = dynamic_cast<json::Bool*>(input05)->getValue()==false;
  std::cout << "  input05 false: " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = input06->getValue()==false;
  std::cout << "  input06 false: " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = input07->getValue()==false;
  std::cout << "  input07 false: " << (pass ? "PASS" : "FAIL")
            << std::endl;

  //// toString
  std::cout << "Test: toString..."
            << std::endl;
  pass = input00->toString()=="true";
  std::cout << "  input00 \"true\": " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = input01->toString()=="true";
  std::cout << "  input01 \"true\": " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = input02->toString()=="true";
  std::cout << "  input02 \"true\": " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = input03->toString()=="true";
  std::cout << "  input03 \"true\": " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = input04->toString()=="false";
  std::cout << "  input04 \"false\": " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = input05->toString()=="false";
  std::cout << "  input05 \"false\": " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = input06->toString()=="false";
  std::cout << "  input06 \"false\": " << (pass ? "PASS" : "FAIL")
            << std::endl;
  pass = input07->toString()=="false";
  std::cout << "  input07 \"false\": " << (pass ? "PASS" : "FAIL")
            << std::endl;
